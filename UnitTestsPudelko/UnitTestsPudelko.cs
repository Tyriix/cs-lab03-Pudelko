...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        #region Pole, Objêtoœæ tests ===================================
        [DataTestMethod, TestCategory("Volume")]
        [DataRow(4.4, 2.1, 0.4, 3.696)]
        [DataRow(2, 2.8, 7.33, 41.048)]
        [DataRow(8.22, 6.043, 0.34, 16.8889764)]
        public void Volume_3params(double a, double b, double c, double volume)
        {
            var p = new Pudelko(a, b, c);
            Assert.AreEqual(volume, p.Objetosc);
        }
        [DataTestMethod, TestCategory("Volume")]
        [DataRow(4.1, 2.1, 0.861)]
        [DataRow(2.88, 2.14, 0.61632)]
        [DataRow(3.22, 6, 1.932)]
        public void Volume_2params(double a, double b, double volume)
        {
            var p = new Pudelko(a, b);
            Assert.AreEqual(volume, p.Objetosc);
        }
        [DataTestMethod, TestCategory("Volume")]
        [DataRow(4.4, 0.044)]
        [DataRow(6.03, 0.0603)]
        [DataRow(3.11, 0.0311)]
        public void Volume_1param(double a, double volume)
        {
            var p = new Pudelko(a);
            Assert.AreEqual(volume, p.Objetosc);
        }
        ...
        [DataRow(4.4, 2.1, 0.4, 23.68)]
        [DataRow(2, 2.8, 7.33, 81.568)]
        [DataRow(8.22, 6.043, 0.34, 109.04576)]
        public void Area_3params(double a, double b, double c, double area)
        {
            var p = new Pudelko(a, b, c);
            Assert.AreEqual(area, p.Pole);
        }
        [DataTestMethod, TestCategory("Area")]
        [DataRow(4.1, 2.1, 18.46)]
        [DataRow(2.88, 2.14, 13.3304)]
        [DataRow(3.22, 6, 40.484)]
        public void Area_2params(double a, double b, double area)
        {
            var p = new Pudelko(a, b);
            Assert.AreEqual(area, p.Pole);
        }
        ...
        [DataRow(6.03, 2.432)]
        [DataRow(3.11, 1.264)]
        public void Area_1param(double a, double area)
        {
            var p = new Pudelko(a);
            Assert.AreEqual(area, p.Pole);
        }
        ...
        #region Equals tests ===========================================
        [TestMethod]
        [DataRow(1.22, 5.33, 0.221, 1.22, 5.33, 0.221)]
        [DataRow(8, 10, 1.22, 8, 10, 1.22)]
        [DataRow(4.21, 4, 6.11, 4.21, 4, 6.11)]
        [DataRow(1, 2.14, 0.2, 1, 2.14, 0.2)]
        [DataRow(6.55, 5.1, 0.75, 6.55, 5.1, 0.75)]
        public void Equals_Operator(double a1, double b1, double c1, double a2, double b2, double c2)
        {
        ...
        #region Operators overloading tests ===========================
        [TestMethod]
        [DataRow(1.22, 5.33, 0.221, 1.22, 5.33, 0.221)]
        [DataRow(8, 10, 1.22, 8, 10, 1.22)]
        [DataRow(4.21, 4, 6.11, 4.21, 4, 6.11)]
        [DataRow(1, 2.14, 0.2, 1, 2.14, 0.2)]
        [DataRow(6.55, 5.1, 0.75, 6.55, 5.1, 0.75)]
        public void EqualSign_Operator(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1);
            var p2 = new Pudelko(a2, b2, c2);
            bool test = p1 == p2;
        ...
        [TestMethod]
        [DataRow(1.22, 5.33, 0.221, 1.1, 4, 0.227)]
        [DataRow(8, 10, 1.22, 2, 8, 4.22)]
        [DataRow(4.21, 4, 6.11, 1.1, 9, 4.567)]
        [DataRow(1, 2.14, 0.2, 2.11, 2.17, 5.222)]
        [DataRow(6.55, 5.1, 0.75, 1.225, 6.221, 0.12)]
        public void NotEqualSign_Operator(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1);
            var p2 = new Pudelko(a2, b2, c2);
            bool test = p1 != p2;
        ...
        [TestMethod]
        [DataRow(1.22, 5.33, 0.221, 1.1, 4, 0.227, 2.320, 5.33, 0.227)]
        [DataRow(8, 10, 1.22, 2, 8, 4.22, 10, 10, 4.22)]
        [DataRow(4.21, 4, 6.11, 1.1, 9, 4.567, 5.310, 9, 6.11)]
        [DataRow(1, 2.14, 0.2, 2.11, 2.17, 5.222, 3.110, 2.17, 5.222)]
        [DataRow(6.55, 5.1, 0.75, 1.225, 6.221, 0.12, 7.775, 6.221, 0.75)]
        public void PlusSign_Operator(double a1, double b1, double c1, double a2, double b2, double c2, double a3, double b3, double c3)
        {
            var p1 = new Pudelko(a1, b1, c1);
            var p2 = new Pudelko(a2, b2, c2);
            var p3 = new Pudelko(a3, b3, c3);
            Assert.AreEqual(p3.ToString(), (p1 + p2).ToString());
        }
        #endregion
        ...
        #region Indexer, enumeration tests ============================
        [TestMethod]
        ...
        [DataRow(2.5, 9.321, 0.1, "2.500 m × 9.321 m × 0.100 m")]
        [DataRow(1.43, 1, 2.55, "1.430 m × 1.000 m × 2.550 m")]
        [DataRow(7, 0.4, 3.112, "7.000 m × 0.400 m × 3.112 m")]
        public void Parse_ReadFrom(double a, double b, double c, string expectedStringRepresentation)
        {
            var p = new Pudelko(a, b, c);
            var parse = Pudelko.Parse(p.ToString());
            Assert.AreEqual(expectedStringRepresentation, parse.ToString());
        }
        #endregion
    }
}